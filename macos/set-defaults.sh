...
#
# The original idea and settings were grabbed from:
...
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "jupiter"
